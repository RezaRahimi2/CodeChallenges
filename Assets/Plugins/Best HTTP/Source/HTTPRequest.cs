...
namespace BestHTTP
{
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        /// </summary>
        public event
            System.Func<HTTPRequest, System.Security.Cryptography.X509Certificates.X509Certificate,
                System.Security.Cryptography.X509Certificates.X509Chain, bool> CustomCertificationValidator;
#endif
        ...
        /// </summary>
        public SecureProtocol.Org.BouncyCastle.Crypto.Tls.IClientCredentialsProvider CustomClientCredentialsProvider
        {
            get;
            set;
        }
...
#if !NETFX_CORE
        internal bool CallCustomCertificationValidator(
